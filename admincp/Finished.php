...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      <h1 class="page-header"><i class="glyphicon glyphicon glyphicon-credit-card"></i> المنتجات المنهية المزايدة</h1>
      <div class="col-md-12">
          <div class="row">
              <div class="col-md-12">
                  <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        $rows = $post->displayPost1("ORDER BY `id` DESC LIMIT $per_page , ".ADMINPREPAGE.""); 
                        $i=1;
                            if($rows != null):
                                foreach ($rows as $row):
                        ?>
                            <tr class="text-center">
                                ...
                                <td><?php echo $category->getCateNameById($row['category']) ?></td>
                                 <td><?php echo $row['price'] ?></td>
                                  <td><a href="payment.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-primary">دفع</a></td>
